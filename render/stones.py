...
blender -b -P render/stones.py -- kind=rough|cut out=render/out/rough frames=120 res=800 samples=256
"""
...
FRAMES = int(A.get("frames", 120))   # 3° per frame: smooth playback
